...
namespace Castmill.Api.Migrations
{
    ...
    [Migration("20260820034033_ArtifactRevisionDependencySnapshots")]
    partial class ArtifactRevisionDependencySnapshots
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Castmill.Core.SourceAsset", b =>
                {
                    ...
                    b.HasIndex("TenantId", "CampaignId", "Kind", "SnapshotHash")
                        .IsUnique();
