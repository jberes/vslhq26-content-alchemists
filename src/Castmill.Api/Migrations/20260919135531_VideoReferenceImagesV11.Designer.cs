...
namespace Castmill.Api.Migrations
{
    ...
    [Migration("20260919135531_VideoReferenceImagesV11")]
    partial class VideoReferenceImagesV11
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Castmill.Api.Auth.ExternalAuthAttempt", b =>
                {
                    ...
                    b.Property<string>("CandidateAvatarContentType")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<byte[]>("CandidateAvatarImage")
                        .HasMaxLength(262144)
                        .HasColumnType("varbinary(max)");
            ...
            modelBuilder.Entity("Castmill.Core.Artifact", b =>
                {
                    ...
                    b.Property<string>("TechnicalBriefJson")
                        .HasMaxLength(8000)
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Castmill.Core.BrandCollaborator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BrandCollaborators");
                });

            modelBuilder.Entity("Castmill.Core.BrandKnowledgeSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BrandKnowledgeSources");
                });

            modelBuilder.Entity("Castmill.Core.BrandMcpServer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("AuthorizationCiphertext")
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");
            ...
            modelBuilder.Entity("Castmill.Core.BrandSkill", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Castmill.Core.Campaign", b =>
                {
                    ...
                    b.Property<string>("AudiencePersona")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Castmill.Core.CampaignCollaborator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CampaignId", "NormalizedEmail")
                        .IsUnique();
            ...
            modelBuilder.Entity("Castmill.Core.ImageSlot", b =>
                {
                    ...
                    b.Property<string>("OverlaySpecJson")
                        .HasMaxLength(8000)
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("VisualBriefInputHash")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Castmill.Core.ReferenceCropPreset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ReferenceCropPresets");
                });

            modelBuilder.Entity("Castmill.Core.ReferenceImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("DerivedAssetId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ReferenceSetId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("SourceFrameAssetId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ReferenceSetId");

                    b.HasIndex("TenantId", "CampaignId", "VideoAssetId");

                    b.HasIndex("TenantId", "ReferenceSetId", "SortOrder");

                    b.ToTable("ReferenceImages");
                });

            modelBuilder.Entity("Castmill.Core.ReferenceSet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("SelectionGoal")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");
            ...
            modelBuilder.Entity("Castmill.Core.BrandCollaborator", b =>
                {
                    b.HasOne("Castmill.Core.BrandProfile", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Castmill.Core.ReferenceImage", b =>
                {
                    b.HasOne("Castmill.Core.ReferenceSet", null)
                        .WithMany()
                        .HasForeignKey("ReferenceSetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
