...
- **Live SEO E2E gate** — an opt-in Playwright scenario drives sign-in → transcript →
  ...
  exact keyword endpoint provenance and multi-keyword competitor visibility, then verifies
  ApexCharts and ApexTree SVGs in Chromium and removes its temporary campaign.
